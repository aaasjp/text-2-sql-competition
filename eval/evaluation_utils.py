...
def save_eval_error_log(exec_results, dev_jsonl_path, dev_json_path, output_path):
    dev_meta = load_jsonl(dev_jsonl_path)
    dev_questions = load_json(dev_json_path)
    error_records = []
    ...
    for result in exec_results:
        ...
        idx = result["sql_idx"]
        meta = dev_meta[idx]
        question_item = dev_questions[idx]
