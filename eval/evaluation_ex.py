...
def execute_model(
    ...
    try:
        ...
        res = 0
        error_type = "timeout"
        error_message = f"execution timeout after {meta_time_out}s"
...
if __name__ == "__main__":
    ...
    args_parser.add_argument("--dev_json_path", type=str, default="./data/dev.json")
    args_parser.add_argument(
        "--error_log_path", type=str, default="./working/evaluate_error_log.jsonl"
    )
    ...
    error_count = save_eval_error_log(
        exec_result,
        args.diff_json_path,
        args.dev_json_path,
        args.error_log_path,
    )
    print(f"Saved {error_count} error records to {args.error_log_path}")
